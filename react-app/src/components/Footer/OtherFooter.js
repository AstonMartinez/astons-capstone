...
const OtherFooter = () => {
    ...
    return (
        <div id='other-footer-parent'>
            <div id='lp-footer-wrapper'>
                ...
                <div id='other-footer-footer'>
                    <img id='footer-art-layer-1' src="https://habitica.com/static/img/midground_foreground_extended2.0fe8082c.png" alt="footer-layer" border="0" />
                </div>
